<?php if(!class_exists('Rain\Tpl')){exit;}?><h1 class="color-fundo-titulo titulo titulo-autorizacao">Autorização de Empréstimo para Alunos</h1>

<p class="p">Fica autorizado o aluno(a) <strong><?php echo htmlspecialchars( $nome_usuario, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>, portador do cpf <strong><?php echo htmlspecialchars( $cpf, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> e telefone <strong><?php echo htmlspecialchars( $telefone_celular, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>, que estuda no curso <strong><?php echo htmlspecialchars( $nome_curso, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> na instituição.</p>
...
<div class="assinatura lado-right">Assinatura do Aluno</div>