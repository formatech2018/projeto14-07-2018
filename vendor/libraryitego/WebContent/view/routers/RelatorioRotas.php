 ...
 * @relatorioAutorizacaoFuncionario=btc
 * @relatorioAutorizacaoAluno=btc
 */
class RelatorioRotas 
{

	public function relatorioAutorizacaoFuncionario($idusuario){

		$acesso = Controller::getAcesso($_SESSION);
		$rain = new RelatorioRainTpl($acesso);
		$relatorio = new RelatorioController();

		$selectEmprestimo = $relatorio->select(new Emprestimo(),true,array('usuario' => array(),'patrimonio' => array('livro' => array())),array(),array('idusuario' => $idusuario, 'data_devolucao' => "''"));
	...
	public function relatorioAutorizacaoAluno($idusuario){
