<?php 
	...
	$app->get("/relatorio/autorizacao/funcionario/:idusuario", function($idusuario){

		session_start();
		$anotacao = Controller::getAnotacoes('RelatorioRotas');
		$ret = Controller::getValidaSessoes($anotacao['relatorioAutorizacaoFuncionario'],$_SESSION);
		if ($ret->getSuccess()) {
		\ViewController\view\routers\RelatorioRotas::relatorioAutorizacaoFuncionario($idusuario);
		}else{
			$acesso = Controller::getAcesso($_SESSION);
			$rain = new RainTpl($acesso);
			$rain->setConteudo(array("mensagem","index"),array(
	...
	$app->get("/relatorio/autorizacao/aluno/:idusuario", function($idusuario){

		session_start();
		$anotacao = Controller::getAnotacoes('RelatorioRotas');
		$ret = Controller::getValidaSessoes($anotacao['relatorioAutorizacaoAluno'],$_SESSION);
		if ($ret->getSuccess()) {
		\ViewController\view\routers\RelatorioRotas::relatorioAutorizacaoAluno($idusuario);
		}else{
			$acesso = Controller::getAcesso($_SESSION);
			$rain = new RainTpl($acesso);
			$rain->setConteudo(array("mensagem","index"),array(
